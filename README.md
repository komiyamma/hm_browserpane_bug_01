...
４台とも「Edge v110.0.1587.63」であり、自動的に3/4～3/5の間の更新日となっている。  

# WebView2ランタイムのバージョンは1台異なるが挙動に変化はない

|  マシン名  |  WebView2ランタイムのバージョン | 更新日 |
|---|---|---|
| r9-3950x-X570  | 110.0.1587.**57** | 3/1 |
| i9-9900ks-B365 | 110.0.1587.63 | 3/3 |
| i7-9700-H310 | 110.0.1587.63 | 3/5 |
...
```
初期段階で「New Edge(Chronium)」が入っているため、「WebView2ランタイム」はマニュアルでインストールしていなかった
```
という違いがあった。  
